...
public class CustomerServiceImpl implements CustomerService {
	...
	public CreateCustomerAccountDto addCustomer(CreateCustomerAccountDto customerAccount) {
		...
		long accountNumber=accountOperation.generateAccountNumber();
	...
	public CustomerDetailDto getCustomerById(int customerId) {
		...
		//System.out.println(userOperation.getCurrentUsername());
		
		if( customerId!= userOperation.getCurrentCustomer().getCustomerId()) {
